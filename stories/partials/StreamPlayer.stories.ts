...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story: 'El reproductor aparece cuando ModoItaliano FM ya está reproduciéndose. Recibe el título y artista del mismo feed de “now playing” que utiliza el masthead; esos metadatos permanecen visibles durante una pausa de buffer, y el reproductor usa el stream en directo de `https://palazzo.gaulatti.com`.'
      }
    }
  }
};
