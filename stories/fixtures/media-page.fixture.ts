...
export const mediaPageFixture: CanonicalArticle = {
  ...
  slug: '/media',
  layout: 'media-page',
  canonicalUrl: 'https://modoitaliano.fm/media',
  ...
  excerpt: 'Browse photos from ModoItaliano assignments.',
  language: 'en',
  featured: false,
  authors: [{ name: 'ModoItaliano Newsroom', slug: 'modoitaliano-newsroom' }],
  categories: [{ name: 'Top Stories', slug: 'top-stories' }],
  body: [],
  seo: {
    metaTitle: 'Assignment Media | ModoItaliano',
    metaDescription: 'Browse photos from ModoItaliano assignments.'
  },
  navigation: {
    categories: [
  ...
  photos: [
    {
      ...
      photographer: 'ModoItaliano Desk',
      location: 'City Hall',
